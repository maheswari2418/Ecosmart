...
import blog2 from '../assets/images/blog/g1.jpeg'
import blog3 from '../assets/images/blog/g4.jpeg'
    ...
    <section className="about-us p-5">
      <div className="row">
        ...
        <div className="col-md-6 d-flex flex-column align-items-center justify-content-center">
          ...
          <p className="card-text mb-3">eco-friendly eCommerce website could represent a company dedicated to promoting and <br/> selling products that are sustainably sourced, manufactured using environmentally friendly practices, and packaged with eco-conscious materials. </p>
          <p className="card-text">This commitment might extend to utilizing renewable energy for hosting servers, implementing energy-efficient design, and advocating for ethical and responsible consumption and <br /> denotes the entity driving the mission and values of sustainability within the eCommerce platform.</p>
        </div>
      </div>
    </section>
