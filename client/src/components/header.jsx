...
import { CgShoppingCart, CgPlus } from 'react-icons/cg'
...
const header = () => {
      ...
      <div className="row">
        <div className="d-flex align-items-center justify-content-between d-none d-md-flex">
          <div className="col-md-4 me-auto">
            <p className='text-black'>The products all are made with natural and sustainable</p>
          </div>
  ...
  <div className="container-xxl">
    <div className="row align-items-center m-0">
      ...
      <div className="col-md-9 row col-lg-10">
        <div className="col-md-3 m-auto">
        <div className="input-group d-none d-lg-flex">
          <input type="text" className="form-control" placeholder="Search products..." aria-label="Find products ..." aria-describedby="basic-addon2" />
        ...
        <div className='menu-links mt-2 d-none d-md-flex d-lg-flex'>
          ...
          <div className='ms-auto gap-2'><NavLink to="/blog" className={location.pathname === '/blog' ? 'active' : 'not-active'} onClick={toggleMenu}>BLOG</NavLink></div>
          <div className='ms-auto gap-2'><NavLink to="/about" className={location.pathname === '/about' ? 'active' : 'not-active'} onClick={toggleMenu}>ABOUT</NavLink></div>
        ...
        <div className="row d-flex justify-content-center">
            <div className="col-10 col-md-1 d-none d-xs-flex d-md-flex m-auto">
